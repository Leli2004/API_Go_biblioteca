...
func (u *CreateUC) Execute(ctx context.Context, input entity.BookCopy, claims *entity.AuthClaims) (returnedCtx context.Context, err error, result entity.BookCopy) {
