...
func NewGetUC(db *sqlx.DB, repo loan.Repository, redisCli *redis.Client) GetUC {
	return GetUC{db: db, repo: repo, redisCli: redisCli}
}

func (u *GetUC) Execute(ctx context.Context, id int) (returnedCtx context.Context, err error, result entity.Loan) {
...
func (u *GetUC) saveRedis(ctx context.Context, result entity.Loan, key string) {
