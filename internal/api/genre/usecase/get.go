...
func NewGetUC(db *sqlx.DB, repo genre.Repository, redisCli *redis.Client) GetUC {
...
func (u *GetUC) Execute(ctx context.Context, id int) (returnedCtx context.Context, err error, result entity.Genre) {
	key := fmt.Sprintf("biblioteca_genre_get_%d", id)
...
func (u *GetUC) saveRedis(ctx context.Context, result entity.Genre, key string) {
