...
func (_c *UseCase_Create_Call) Return(_a0 context.Context, _a1 error, _a2 entity.Genre) *UseCase_Create_Call {
...
func (_m *UseCase) Get(ctx context.Context, id int) (context.Context, error, entity.Genre) {
	...
	var r1 error
	var r2 entity.Genre
	if rf, ok := ret.Get(0).(func(context.Context, int) (context.Context, error, entity.Genre)); ok {
		return rf(ctx, id)
	}
	...
	if rf, ok := ret.Get(2).(func(context.Context, int) entity.Genre); ok {
		r2 = rf(ctx, id)
	} else {
		r2 = ret.Get(2).(entity.Genre)
	}
...
func (_c *UseCase_Get_Call) Return(_a0 context.Context, _a1 error, _a2 entity.Genre) *UseCase_Get_Call {
	_c.Call.Return(_a0, _a1, _a2)
	return _c
}

func (_c *UseCase_Get_Call) RunAndReturn(run func(context.Context, int) (context.Context, error, entity.Genre)) *UseCase_Get_Call {
	_c.Call.Return(run)
	return _c
}

// List provides a mock function with given fields: ctx, input
func (_m *UseCase) List(ctx context.Context, input entity.GenreFilters) (context.Context, error, entity.GenreList) {
	...
	if rf, ok := ret.Get(0).(func(context.Context, entity.GenreFilters) (context.Context, error, entity.GenreList)); ok {
		return rf(ctx, input)
	}
	if rf, ok := ret.Get(0).(func(context.Context, entity.GenreFilters) context.Context); ok {
		r0 = rf(ctx, input)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(context.Context)
	...
	if rf, ok := ret.Get(1).(func(context.Context, entity.GenreFilters) error); ok {
		r1 = rf(ctx, input)
	} else {
		r1 = ret.Error(1)
	}

	if rf, ok := ret.Get(2).(func(context.Context, entity.GenreFilters) entity.GenreList); ok {
		r2 = rf(ctx, input)
	} else {
...
func (_c *UseCase_List_Call) Run(run func(ctx context.Context, input entity.GenreFilters)) *UseCase_List_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(entity.GenreFilters))
	})
	return _c
}

func (_c *UseCase_List_Call) Return(_a0 context.Context, _a1 error, _a2 entity.GenreList) *UseCase_List_Call {
	_c.Call.Return(_a0, _a1, _a2)
	return _c
}

func (_c *UseCase_List_Call) RunAndReturn(run func(context.Context, entity.GenreFilters) (context.Context, error, entity.GenreList)) *UseCase_List_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *UseCase_Update_Call) Return(_a0 context.Context, _a1 error, _a2 entity.Genre) *UseCase_Update_Call {
	_c.Call.Return(_a0, _a1, _a2)
	return _c
}
