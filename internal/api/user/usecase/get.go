...
func NewGetUC(db *sqlx.DB, repo user.Repository) GetUC {
	return GetUC{db: db, repo: repo}
}

func (u *GetUC) Execute(ctx context.Context, id int) (returnedCtx context.Context, err error, result entity.User) {
