...
func NewListUC(db *sqlx.DB, repo user.Repository) ListUC {
	return ListUC{db: db, repo: repo}
}

func (u *ListUC) Execute(ctx context.Context, input entity.UserFilters) (returnedCtx context.Context, err error, result entity.UserList) {
